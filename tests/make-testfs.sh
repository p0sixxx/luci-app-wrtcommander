...
TESTFS="/tmp/proton-filemanager-test"
...
printf 'i am hidden\n' > "$TESTFS/.hidden"
printf 'a very long file name that exercises name-length handling in the UI and backend alike.txt' > "$TESTFS/this-is-a-deliberately-very-long-file-name-used-to-exercise-long-name-handling-in-the-listing-and-rename-dialogs-of-proton-file-manager.txt"
