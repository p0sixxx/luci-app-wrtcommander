...
менеджера, без `.ipk`, без SDK и тулчейна. Сборка нормального пакета
OpenWrt — следующий этап, после обкатки на живом железе.
